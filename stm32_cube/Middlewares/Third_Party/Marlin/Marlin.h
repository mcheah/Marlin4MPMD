...
#define SERIAL_NB_BYTES_IN_RX_BUFFER (MYSERIAL.println(MYSERIAL.nb_bytes_in_rx_buffer()))
#ifdef FLOW_CONTROL_BY_OK
#define SERIAL_NB_OK_SENT (MYSERIAL.println(MYSERIAL.get_nb_OK_sent()))
#endif
#endif
...
{
#if MB(STM_3DPRINT)
  MYSERIAL.write(str); //nothing in program memory
#else
