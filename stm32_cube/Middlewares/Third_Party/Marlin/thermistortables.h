...
#if (THERMISTORHEATER_0 == 21) || (THERMISTORHEATER_1 == 21)  || (THERMISTORHEATER_2 == 21) || (THERMISTORBED == 21) //100k bed thermistor with 1K divider (beta 4066)
...
{       69*OVERSAMPLENR ,       361     },
{       86*OVERSAMPLENR ,       338     },
{       103*OVERSAMPLENR ,       321     },
{       120*OVERSAMPLENR ,       306     },
{       137*OVERSAMPLENR ,       294     },
{       154*OVERSAMPLENR ,       283     },
{       171*OVERSAMPLENR ,       274     },
{       188*OVERSAMPLENR ,       266     },
{       205*OVERSAMPLENR ,       258     },
{       222*OVERSAMPLENR ,       251     },
{       239*OVERSAMPLENR ,       245     },
{       256*OVERSAMPLENR ,       239     },
{       273*OVERSAMPLENR ,       233     },
{       290*OVERSAMPLENR ,       228     },
{       307*OVERSAMPLENR ,       223     },
{       324*OVERSAMPLENR        ,       218     },
{       341*OVERSAMPLENR        ,       214     },
{       358*OVERSAMPLENR        ,       210     },
{       375*OVERSAMPLENR        ,       206     },
{       392*OVERSAMPLENR        ,       202     },
{       409*OVERSAMPLENR        ,       198     },
{       426*OVERSAMPLENR        ,       194     },
{       443*OVERSAMPLENR        ,       190     },
{       460*OVERSAMPLENR        ,       187     },
{       477*OVERSAMPLENR        ,       183     },
{       494*OVERSAMPLENR        ,       180     },
{       511*OVERSAMPLENR        ,       177     },
{       528*OVERSAMPLENR        ,       173     },
{       545*OVERSAMPLENR        ,       170     },
{       562*OVERSAMPLENR        ,       167     },
{       579*OVERSAMPLENR        ,       164     },
{       596*OVERSAMPLENR        ,       161     },
{       613*OVERSAMPLENR        ,       157     },
{       630*OVERSAMPLENR        ,       154     },
{       647*OVERSAMPLENR        ,       151     },
{       664*OVERSAMPLENR        ,       148     },
{       681*OVERSAMPLENR        ,       145     },
{       698*OVERSAMPLENR        ,       142      },
{       715*OVERSAMPLENR        ,       138      },
{       732*OVERSAMPLENR        ,       135      },
{       749*OVERSAMPLENR        ,       132      },
{       766*OVERSAMPLENR        ,       128      },
{       783*OVERSAMPLENR        ,       125      },
{       800*OVERSAMPLENR        ,       121      },
{       817*OVERSAMPLENR        ,       117      },
{       834*OVERSAMPLENR        ,       113      },
{       851*OVERSAMPLENR        ,       109      },
{       868*OVERSAMPLENR        ,       105      },
{       885*OVERSAMPLENR        ,       100      },
{       902*OVERSAMPLENR        ,       95      },
{       919*OVERSAMPLENR        ,       89      },
{       936*OVERSAMPLENR        ,       83      },
{       953*OVERSAMPLENR        ,       76      },
...
{       987*OVERSAMPLENR        ,       56      },
{       1004*OVERSAMPLENR       ,       40      },
{       1021*OVERSAMPLENR       ,       0       } //safety
};
#endif
#if (THERMISTORHEATER_0 == 22) || (THERMISTORHEATER_1 == 22) || (THERMISTORHEATER_2 == 22) || (THERMISTORBED == 22) //ST EVALR3DPRINT_V1 board with PrusaI3rework1.5 thermistance (to be improved)
const short temptable_22[][2]  PROGMEM = {
{       102*OVERSAMPLENR        ,       240     },
{       123*OVERSAMPLENR        ,       230     },
{       145*OVERSAMPLENR        ,       220     },
{       166*OVERSAMPLENR        ,       210     },
{       200*OVERSAMPLENR        ,       200     },
{       213*OVERSAMPLENR        ,       190     },
{       232*OVERSAMPLENR        ,       185     },
{       295*OVERSAMPLENR        ,       180     },
{       301*OVERSAMPLENR        ,       170     },
{       310*OVERSAMPLENR        ,       160     },
{       332*OVERSAMPLENR        ,       150     },
{       379*OVERSAMPLENR        ,       140     },
{       435*OVERSAMPLENR        ,       130     },
{       492*OVERSAMPLENR        ,       120     },
{       562*OVERSAMPLENR        ,       110     },
{       641*OVERSAMPLENR        ,       100     },
{       678*OVERSAMPLENR        ,       95      },
{       834*OVERSAMPLENR        ,       92      },
{       884*OVERSAMPLENR        ,       85      },
{       940*OVERSAMPLENR        ,       80      },
...
{       994*OVERSAMPLENR        ,       50      },
{       997*OVERSAMPLENR        ,       45      },
{       1002*OVERSAMPLENR       ,       38      },
{       1008*OVERSAMPLENR       ,       32      },
{       1013*OVERSAMPLENR       ,       25      },
{       1016*OVERSAMPLENR       ,       0       } //safety
};          
#endif

#if (THERMISTORHEATER_0 == 23) || (THERMISTORHEATER_1 == 23) || (THERMISTORHEATER_2 == 23) || (THERMISTORBED == 23) //ST EVALR3DPRINT_V1 board with E3Dv6 Semitec thermistance 
...
#if (THERMISTORHEATER_0 == 24) || (THERMISTORHEATER_1 == 24) || (THERMISTORHEATER_2 == 24) //ST EVALR3DPRINT_V1 board with PrusaI3 rework1.5 extruder head thermistance
const short temptable_24[][2]  PROGMEM = {
{       230*OVERSAMPLENR        ,       250     },
{       266*OVERSAMPLENR        ,       237     },
{       295*OVERSAMPLENR        ,       227     },
{       362*OVERSAMPLENR        ,       212     },
{       390*OVERSAMPLENR        ,       205     },
{       436*OVERSAMPLENR        ,       196     },
{       489*OVERSAMPLENR        ,       185     },
{       560*OVERSAMPLENR        ,       175     },
{       623*OVERSAMPLENR        ,       162     },
{       677*OVERSAMPLENR        ,       150     },
{       749*OVERSAMPLENR        ,       140     },
{       813*OVERSAMPLENR        ,       126     },
{       883*OVERSAMPLENR        ,       106     },
{       950*OVERSAMPLENR        ,       82      },
{       972*OVERSAMPLENR        ,       71      },
{       991*OVERSAMPLENR        ,       56      },
{       1000*OVERSAMPLENR       ,       47      },
{       1014*OVERSAMPLENR       ,       23      },
{       1016*OVERSAMPLENR       ,       17      },
{       1018*OVERSAMPLENR       ,       0       } //safety
};          
#endif

#if (THERMISTORBED == 25) //ST EVALR3DPRINT_V1 board with PrusaI3 rework1.5 bed thermistance 
const short temptable_25[][2]  PROGMEM = {
{       813*OVERSAMPLENR        ,       120     },//extrapolated from Table 24
{       902*OVERSAMPLENR        ,       93      },
{       951*OVERSAMPLENR        ,       76      },
{       974*OVERSAMPLENR        ,       64      },
{       990*OVERSAMPLENR        ,       53      },
{       1001*OVERSAMPLENR       ,       43      },
{       1014*OVERSAMPLENR       ,       24      },
{       1016*OVERSAMPLENR       ,       17      },
{       1018*OVERSAMPLENR       ,       0       } //safety
};          
#endif
