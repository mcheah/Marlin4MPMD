...
#ifndef NO_WIFI
  #define WIFI_SSID "3dpserver" //Max of 32 characters
  #define WIFI_WEP_KEY "1122334455" //Either 10 or 26 HEX characters (0-9,A-F)  
  #if defined(PROD_TEST)
    #define WIFI_FW_VERSION "150410-c2e37a3"
    #define WIFI_FS_VERSION "fsversion01102015_001"
...
#endif //#if STM_3DPRINT
#endif //#ifndef MOTHERBOARD

// Define this to set a custom name for your generic Mendel,
#define CUSTOM_MENDEL_NAME "PrusaI3 rework1.5"
...
// M303 command result for PRUSA I3 (customised for ST)
  #define  DEFAULT_Kp 33.94
  #define  DEFAULT_Ki 2.42
  #define  DEFAULT_Kd 118.79
...
//SD
// The microcontroller can store settings in the SD card, e.g. max velocity...
// M500 - stores parameters in the SD card
// M501 - reads parameters from the SD card (if you need reset them after you changed them temporarily).
// M502 - reverts to the default "factory settings".  You still need to store them in the SD card afterwards if you want to.
#if MB(STM_3DPRINT)
#define SDSTSUPPORT //Flag to support SD card with ST boards
#ifdef SDSTSUPPORT
#define SD_SETTINGS
#endif
#endif
...
//#define SERVO_ENDSTOP_ANGLES {0,0, 0,0, 180,60} // X,Y,Z Axis Extend and Retract angles
