...
//#define DEBUG_LEVELING_FEATURE
  ...
  #define AUTO_BED_LEVELING_THETA_POINTS AUTO_BED_LEVELING_GRID_POINTS
  #define AUTO_BED_LEVELING_RAD_POINTS AUTO_BED_LEVELING_GRID_POINTS
#endif
