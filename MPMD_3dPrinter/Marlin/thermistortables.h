...
// Verified by linagee. Source: http://shop.arcol.hu/static/datasheets/thermistors.pdf
// Calculated using 4.7kohm pullup, voltage divider math, and manufacturer provided temp/resistance
const int temptable_5[][2] PROGMEM = {
  {    1 * OVERSAMPLENR * 4, 713 },
  {   17 * OVERSAMPLENR * 4, 300 }, // top rating 300C
  {   20 * OVERSAMPLENR * 4, 290 },
  {   23 * OVERSAMPLENR * 4, 280 },
  {   27 * OVERSAMPLENR * 4, 270 },
  {   31 * OVERSAMPLENR * 4, 260 },
  {   37 * OVERSAMPLENR * 4, 250 },
  {   43 * OVERSAMPLENR * 4, 240 },
  {   51 * OVERSAMPLENR * 4, 230 },
  {   61 * OVERSAMPLENR * 4, 220 },
  {   73 * OVERSAMPLENR * 4, 210 },
  {   87 * OVERSAMPLENR * 4, 200 },
  {  106 * OVERSAMPLENR * 4, 190 },
  {  128 * OVERSAMPLENR * 4, 180 },
  {  155 * OVERSAMPLENR * 4, 170 },
  {  189 * OVERSAMPLENR * 4, 160 },
  {  230 * OVERSAMPLENR * 4, 150 },
  {  278 * OVERSAMPLENR * 4, 140 },
  {  336 * OVERSAMPLENR * 4, 130 },
  {  402 * OVERSAMPLENR * 4, 120 },
  {  476 * OVERSAMPLENR * 4, 110 },
  {  554 * OVERSAMPLENR * 4, 100 },
  {  635 * OVERSAMPLENR * 4,  90 },
  {  713 * OVERSAMPLENR * 4,  80 },
  {  784 * OVERSAMPLENR * 4,  70 },
  {  846 * OVERSAMPLENR * 4,  60 },
  {  897 * OVERSAMPLENR * 4,  50 },
  {  937 * OVERSAMPLENR * 4,  40 },
  {  966 * OVERSAMPLENR * 4,  30 },
  {  986 * OVERSAMPLENR * 4,  20 },
  { 1000 * OVERSAMPLENR * 4,  10 },
  { 1010 * OVERSAMPLENR * 4,   0 }
};
#endif
...
const int temptable_11[][2] PROGMEM = {
  {    1 * OVERSAMPLENR * 4, 938 },
  {   31 * OVERSAMPLENR * 4, 314 },
  {   41 * OVERSAMPLENR * 4, 290 },
  {   51 * OVERSAMPLENR * 4, 272 },
  {   61 * OVERSAMPLENR * 4, 258 },
  {   71 * OVERSAMPLENR * 4, 247 },
  {   81 * OVERSAMPLENR * 4, 237 },
  {   91 * OVERSAMPLENR * 4, 229 },
  {  101 * OVERSAMPLENR * 4, 221 },
  {  111 * OVERSAMPLENR * 4, 215 },
  {  121 * OVERSAMPLENR * 4, 209 },
  {  131 * OVERSAMPLENR * 4, 204 },
  {  141 * OVERSAMPLENR * 4, 199 },
  {  151 * OVERSAMPLENR * 4, 195 },
  {  161 * OVERSAMPLENR * 4, 190 },
  {  171 * OVERSAMPLENR * 4, 187 },
  {  181 * OVERSAMPLENR * 4, 183 },
  {  191 * OVERSAMPLENR * 4, 179 },
  {  201 * OVERSAMPLENR * 4, 176 },
  {  221 * OVERSAMPLENR * 4, 170 },
  {  241 * OVERSAMPLENR * 4, 165 },
  {  261 * OVERSAMPLENR * 4, 160 },
  {  281 * OVERSAMPLENR * 4, 155 },
  {  301 * OVERSAMPLENR * 4, 150 },
  {  331 * OVERSAMPLENR * 4, 144 },
  {  361 * OVERSAMPLENR * 4, 139 },
  {  391 * OVERSAMPLENR * 4, 133 },
  {  421 * OVERSAMPLENR * 4, 128 },
  {  451 * OVERSAMPLENR * 4, 123 },
  {  491 * OVERSAMPLENR * 4, 117 },
  {  531 * OVERSAMPLENR * 4, 111 },
  {  571 * OVERSAMPLENR * 4, 105 },
  {  611 * OVERSAMPLENR * 4, 100 },
  {  641 * OVERSAMPLENR * 4,  95 },
  {  681 * OVERSAMPLENR * 4,  90 },
  {  711 * OVERSAMPLENR * 4,  85 },
  {  751 * OVERSAMPLENR * 4,  79 },
  {  791 * OVERSAMPLENR * 4,  72 },
  {  811 * OVERSAMPLENR * 4,  69 },
  {  831 * OVERSAMPLENR * 4,  65 },
  {  871 * OVERSAMPLENR * 4,  57 },
  {  881 * OVERSAMPLENR * 4,  55 },
  {  901 * OVERSAMPLENR * 4,  51 },
  {  921 * OVERSAMPLENR * 4,  45 },
  {  941 * OVERSAMPLENR * 4,  39 },
  {  971 * OVERSAMPLENR * 4,  28 },
  {  981 * OVERSAMPLENR * 4,  23 },
  {  991 * OVERSAMPLENR * 4,  17 },
  { 1001 * OVERSAMPLENR * 4,   9 },
  { 1021 * OVERSAMPLENR * 4, -27 }
};
#endif
...
#if ANY_THERMISTOR_IS(72) // mpmd 100k EPCOS 4.7k, 3.3V
#if (THERMISTORHEATER_0 == 72)
  #define HEATER_0_RAW_HI_TEMP 0
  #define HEATER_0_RAW_LO_TEMP 65535
#endif
#if (THERMISTORHEATER_1 == 72)
  #define HEATER_1_RAW_HI_TEMP 0
  #define HEATER_1_RAW_LO_TEMP 65535
#endif
#if (THERMISTORHEATER_2 == 72)
  #define HEATER_2_RAW_HI_TEMP 0
  #define HEATER_2_RAW_LO_TEMP 65535
#endif
#if (THERMISTORHEATER_3 == 72)
...
#endif
const int temptable_72[][2] PROGMEM = {
  {   8 * OVERSAMPLENR*4,  336 },
  {   16 * OVERSAMPLENR*4, 316 },
  {   32 * OVERSAMPLENR*4, 278 },
  {   47 * OVERSAMPLENR*4, 251 },
  {   63 * OVERSAMPLENR*4, 233 },
  {   78 * OVERSAMPLENR*4, 220 },
  {   94 * OVERSAMPLENR*4, 208 },
  {  109 * OVERSAMPLENR*4, 200 },
  {  117 * OVERSAMPLENR*4, 196 },
  {  125 * OVERSAMPLENR*4, 192 },
  {  140 * OVERSAMPLENR*4, 186 },
  {  156 * OVERSAMPLENR*4, 180 },
  {  187 * OVERSAMPLENR*4, 170 },
  {  218 * OVERSAMPLENR*4, 161 },
  {  249 * OVERSAMPLENR*4, 154 },
  {  280 * OVERSAMPLENR*4, 147 },
  {  311 * OVERSAMPLENR*4, 141 },
  {  342 * OVERSAMPLENR*4, 136 },
  {  373 * OVERSAMPLENR*4, 131 },
  {  404 * OVERSAMPLENR*4, 126 },
  {  435 * OVERSAMPLENR*4, 121 },
  {  466 * OVERSAMPLENR*4, 116 },
  {  497 * OVERSAMPLENR*4, 112 },
  {  528 * OVERSAMPLENR*4, 108 },
  {  559 * OVERSAMPLENR*4, 104 },
  {  590 * OVERSAMPLENR*4, 100 },
  {  621 * OVERSAMPLENR*4,  96 },
  {  652 * OVERSAMPLENR*4,  91 },
  {  683 * OVERSAMPLENR*4,  88 },
  {  714 * OVERSAMPLENR*4,  83 },
  {  745 * OVERSAMPLENR*4,  79 },
  {  776 * OVERSAMPLENR*4,  74 },
  {  807 * OVERSAMPLENR*4,  69 },
  {  839 * OVERSAMPLENR*4,  64 },
  {  869 * OVERSAMPLENR*4,  57 },
  {  900 * OVERSAMPLENR*4,  51 },
  {  931 * OVERSAMPLENR*4,  43 },
  {  939 * OVERSAMPLENR*4,  41 },
  {  947 * OVERSAMPLENR*4,  38 },
  {  955 * OVERSAMPLENR*4,  36 },
  {  962 * OVERSAMPLENR*4,  32 },
  {  970 * OVERSAMPLENR*4,  28 },
  {  978 * OVERSAMPLENR*4,  23 },
  {  986 * OVERSAMPLENR*4,  17 },
  {  993 * OVERSAMPLENR*4,  11 },
  { 1009 * OVERSAMPLENR*4,   5 },
  { 1017 * OVERSAMPLENR*4,   0 } // safety
};
#endif

#if ANY_THERMISTOR_IS(73) // mpmd 100k EPCOS 4.7k, 3.3V, adjusted
#if (THERMISTORHEATER_0 == 73)
  #define HEATER_0_RAW_HI_TEMP 0
  #define HEATER_0_RAW_LO_TEMP 65535
#endif
#if (THERMISTORHEATER_1 == 73)
  #define HEATER_1_RAW_HI_TEMP 0
  #define HEATER_1_RAW_LO_TEMP 65535
#endif
#if (THERMISTORHEATER_2 == 73)
  #define HEATER_2_RAW_HI_TEMP 0
  #define HEATER_2_RAW_LO_TEMP 65535
#endif
#if (THERMISTORHEATER_3 == 73)
  #define HEATER_3_RAW_HI_TEMP 0
  #define HEATER_3_RAW_LO_TEMP 65535
#endif
#if (THERMISTORBED == 73)
  ...
  #define HEATER_BED_RAW_LO_TEMP 65535
#endif
const unsigned short temptable_73[][2] PROGMEM = {
  {   8 * OVERSAMPLENR*4,  325 },
  {   16 * OVERSAMPLENR*4, 301 },
  {   32 * OVERSAMPLENR*4, 261 },
  {   47 * OVERSAMPLENR*4, 239 },
  {   63 * OVERSAMPLENR*4, 219 },
  {   78 * OVERSAMPLENR*4, 208 },
  {   93 * OVERSAMPLENR*4, 197 },
  {  109 * OVERSAMPLENR*4, 189 },
  {  117 * OVERSAMPLENR*4, 185 },
  {  125 * OVERSAMPLENR*4, 182 },
  {  140 * OVERSAMPLENR*4, 176 },
  {  156 * OVERSAMPLENR*4, 170 },
  {  187 * OVERSAMPLENR*4, 163 },
  {  218 * OVERSAMPLENR*4, 156 },
  {  248 * OVERSAMPLENR*4, 149 },
  {  280 * OVERSAMPLENR*4, 141 },
  {  311 * OVERSAMPLENR*4, 134 },
  {  342 * OVERSAMPLENR*4, 130 },
  {  372 * OVERSAMPLENR*4, 125 },
  {  404 * OVERSAMPLENR*4, 121 },
  {  436 * OVERSAMPLENR*4, 116 },
  {  465 * OVERSAMPLENR*4, 111 },
  {  497 * OVERSAMPLENR*4, 107 },
  {  528 * OVERSAMPLENR*4, 104 },
  {  559 * OVERSAMPLENR*4, 100 },
  {  588 * OVERSAMPLENR*4,  96 },
  {  622 * OVERSAMPLENR*4,  92 },
  {  651 * OVERSAMPLENR*4,  88 },
  {  684 * OVERSAMPLENR*4,  83 },
  {  714 * OVERSAMPLENR*4,  79 },
  {  744 * OVERSAMPLENR*4,  75 },
  {  776 * OVERSAMPLENR*4,  71 },
  {  807 * OVERSAMPLENR*4,  65 },
  {  837 * OVERSAMPLENR*4,  59 },
  {  870 * OVERSAMPLENR*4,  53 },
  {  901 * OVERSAMPLENR*4,  47 },
  {  931 * OVERSAMPLENR*4,  41 },
  {  939 * OVERSAMPLENR*4,  38 },
  {  946 * OVERSAMPLENR*4,  36 },
  {  955 * OVERSAMPLENR*4,  33 },
  {  962 * OVERSAMPLENR*4,  31 },
  {  969 * OVERSAMPLENR*4,  28 },
  {  976 * OVERSAMPLENR*4,  24 },
  {  986 * OVERSAMPLENR*4,  19 },
  {  994 * OVERSAMPLENR*4,  15 },
  { 1011 * OVERSAMPLENR*4,   5 },
  { 1016 * OVERSAMPLENR*4,   0 } // safety
};
#endif
...
{   96 * OVERSAMPLENR,   298 },
{   99 * OVERSAMPLENR,   295 },
{   104 * OVERSAMPLENR,   292 },
{   108 * OVERSAMPLENR,   289 },
{   113 * OVERSAMPLENR,   286 },
{   117 * OVERSAMPLENR,   283 },
{   123 * OVERSAMPLENR,   280 },
{   128 * OVERSAMPLENR,   277 },
{   134 * OVERSAMPLENR,   274 },
{   139 * OVERSAMPLENR,   271 },
{   146 * OVERSAMPLENR,   268 },
{   152 * OVERSAMPLENR,   265 },
{   159 * OVERSAMPLENR,   262 },
{   167 * OVERSAMPLENR,   259 },
{   174 * OVERSAMPLENR,   256 },
{   183 * OVERSAMPLENR,   253 },
{   191 * OVERSAMPLENR,   250 },
{   200 * OVERSAMPLENR,   247 },
{   210 * OVERSAMPLENR,   244 },
{   220 * OVERSAMPLENR,   241 },
{   231 * OVERSAMPLENR,   238 },
{   243 * OVERSAMPLENR,   235 },
{   255 * OVERSAMPLENR,   232 },
{   268 * OVERSAMPLENR,   229 },
{   281 * OVERSAMPLENR,   226 },
{   295 * OVERSAMPLENR,   223 },
{   311 * OVERSAMPLENR,   220 },
{   327 * OVERSAMPLENR,   217 },
{   344 * OVERSAMPLENR,   214 },
{   362 * OVERSAMPLENR,   211 },
{   381 * OVERSAMPLENR,   208 },
{   401 * OVERSAMPLENR,   205 },
{   423 * OVERSAMPLENR,   202 },
{   445 * OVERSAMPLENR,   199 },
{   469 * OVERSAMPLENR,   196 },
{   495 * OVERSAMPLENR,   193 },
{   522 * OVERSAMPLENR,   190 },
{   551 * OVERSAMPLENR,   187 },
{   581 * OVERSAMPLENR,   184 },
{   613 * OVERSAMPLENR,   181 },
{   647 * OVERSAMPLENR,   178 },
{   683 * OVERSAMPLENR,   175 },
{   721 * OVERSAMPLENR,   172 },
{   761 * OVERSAMPLENR,   169 },
{   803 * OVERSAMPLENR,   166 },
{   848 * OVERSAMPLENR,   163 },
{   895 * OVERSAMPLENR,   160 },
{   945 * OVERSAMPLENR,   157 },
{   997 * OVERSAMPLENR,   154 },
{   1051 * OVERSAMPLENR,   151 },
{   1109 * OVERSAMPLENR,   148 },
{   1169 * OVERSAMPLENR,   145 },
{   1231 * OVERSAMPLENR,   142 },
{   1297 * OVERSAMPLENR,   139 },
{   1365 * OVERSAMPLENR,   136 },
{   1436 * OVERSAMPLENR,   133 },
{   1509 * OVERSAMPLENR,   130 },
{   1585 * OVERSAMPLENR,   127 },
{   1664 * OVERSAMPLENR,   124 },
{   1744 * OVERSAMPLENR,   121 },
{   1827 * OVERSAMPLENR,   118 },
{   1911 * OVERSAMPLENR,   115 },
{   1998 * OVERSAMPLENR,   112 },
{   2085 * OVERSAMPLENR,   109 },
{   2174 * OVERSAMPLENR,   106 },
{   2263 * OVERSAMPLENR,   103 },
{   2353 * OVERSAMPLENR,   100 },
{   2443 * OVERSAMPLENR,   97 },
{   2533 * OVERSAMPLENR,   94 },
{   2621 * OVERSAMPLENR,   91 },
{   2709 * OVERSAMPLENR,   88 },
{   2796 * OVERSAMPLENR,   85 },
{   2880 * OVERSAMPLENR,   82 },
{   2963 * OVERSAMPLENR,   79 },
{   3043 * OVERSAMPLENR,   76 },
{   3120 * OVERSAMPLENR,   73 },
{   3194 * OVERSAMPLENR,   70 },
{   3266 * OVERSAMPLENR,   67 },
{   3334 * OVERSAMPLENR,   64 },
{   3398 * OVERSAMPLENR,   61 },
{   3459 * OVERSAMPLENR,   58 },
{   3517 * OVERSAMPLENR,   55 },
{   3570 * OVERSAMPLENR,   52 },
{   3621 * OVERSAMPLENR,   49 },
{   3667 * OVERSAMPLENR,   46 },
{   3710 * OVERSAMPLENR,   43 },
{   3750 * OVERSAMPLENR,   40 },
{   3787 * OVERSAMPLENR,   37 },
{   3821 * OVERSAMPLENR,   34 },
{   3851 * OVERSAMPLENR,   31 },
{   3879 * OVERSAMPLENR,   28 },
{   3904 * OVERSAMPLENR,   25 },
{   3927 * OVERSAMPLENR,   22 },
{   3947 * OVERSAMPLENR,   19 },
{   3966 * OVERSAMPLENR,   16 },
{   3982 * OVERSAMPLENR,   13 },
{   3997 * OVERSAMPLENR,   10 }
};
#endif

#if ANY_THERMISTOR_IS(75) // A
#if (THERMISTORHEATER_0 == 75)
  #define HEATER_0_RAW_HI_TEMP 0
  #define HEATER_0_RAW_LO_TEMP 65535
#endif
#if (THERMISTORHEATER_1 == 75)
  #define HEATER_1_RAW_HI_TEMP 0
  #define HEATER_1_RAW_LO_TEMP 65535
#endif
#if (THERMISTORHEATER_2 == 75)
  #define HEATER_2_RAW_HI_TEMP 0
  #define HEATER_2_RAW_LO_TEMP 65535
#endif
#if (THERMISTORHEATER_3 == 75)
  #define HEATER_3_RAW_HI_TEMP 0
  #define HEATER_3_RAW_LO_TEMP 65535
#endif
#if (THERMISTORBED == 75)
  ...
  #define HEATER_BED_RAW_LO_TEMP 65535
#endif
const int temptable_75[][2] PROGMEM = {
{   46 * OVERSAMPLENR,   349 },
{   48 * OVERSAMPLENR,   346 },
{   50 * OVERSAMPLENR,   343 },
{   52 * OVERSAMPLENR,   340 },
...
{   94 * OVERSAMPLENR,   295 },
{   98 * OVERSAMPLENR,   292 },
{   102 * OVERSAMPLENR,   289 },
{   106 * OVERSAMPLENR,   286 },
{   111 * OVERSAMPLENR,   283 },
{   116 * OVERSAMPLENR,   280 },
{   121 * OVERSAMPLENR,   277 },
{   127 * OVERSAMPLENR,   274 },
{   133 * OVERSAMPLENR,   271 },
{   139 * OVERSAMPLENR,   268 },
{   145 * OVERSAMPLENR,   265 },
{   152 * OVERSAMPLENR,   262 },
{   159 * OVERSAMPLENR,   259 },
{   167 * OVERSAMPLENR,   256 },
{   175 * OVERSAMPLENR,   253 },
{   184 * OVERSAMPLENR,   250 },
{   193 * OVERSAMPLENR,   247 },
{   202 * OVERSAMPLENR,   244 },
{   212 * OVERSAMPLENR,   241 },
{   223 * OVERSAMPLENR,   238 },
{   234 * OVERSAMPLENR,   235 },
{   246 * OVERSAMPLENR,   232 },
{   259 * OVERSAMPLENR,   229 },
{   273 * OVERSAMPLENR,   226 },
{   287 * OVERSAMPLENR,   223 },
{   302 * OVERSAMPLENR,   220 },
{   318 * OVERSAMPLENR,   217 },
{   335 * OVERSAMPLENR,   214 },
{   353 * OVERSAMPLENR,   211 },
{   372 * OVERSAMPLENR,   208 },
{   393 * OVERSAMPLENR,   205 },
{   414 * OVERSAMPLENR,   202 },
{   437 * OVERSAMPLENR,   199 },
{   461 * OVERSAMPLENR,   196 },
{   487 * OVERSAMPLENR,   193 },
{   514 * OVERSAMPLENR,   190 },
{   543 * OVERSAMPLENR,   187 },
{   573 * OVERSAMPLENR,   184 },
{   606 * OVERSAMPLENR,   181 },
{   640 * OVERSAMPLENR,   178 },
{   676 * OVERSAMPLENR,   175 },
{   715 * OVERSAMPLENR,   172 },
{   755 * OVERSAMPLENR,   169 },
{   798 * OVERSAMPLENR,   166 },
{   843 * OVERSAMPLENR,   163 },
{   891 * OVERSAMPLENR,   160 },
{   941 * OVERSAMPLENR,   157 },
{   993 * OVERSAMPLENR,   154 },
{   1049 * OVERSAMPLENR,   151 },
{   1107 * OVERSAMPLENR,   148 },
{   1168 * OVERSAMPLENR,   145 },
{   1231 * OVERSAMPLENR,   142 },
{   1297 * OVERSAMPLENR,   139 },
{   1366 * OVERSAMPLENR,   136 },
{   1438 * OVERSAMPLENR,   133 },
{   1512 * OVERSAMPLENR,   130 },
{   1589 * OVERSAMPLENR,   127 },
{   1668 * OVERSAMPLENR,   124 },
{   1750 * OVERSAMPLENR,   121 },
{   1833 * OVERSAMPLENR,   118 },
{   1918 * OVERSAMPLENR,   115 },
{   2005 * OVERSAMPLENR,   112 },
{   2093 * OVERSAMPLENR,   109 },
{   2182 * OVERSAMPLENR,   106 },
{   2272 * OVERSAMPLENR,   103 },
{   2362 * OVERSAMPLENR,   100 },
{   2452 * OVERSAMPLENR,   97 },
{   2542 * OVERSAMPLENR,   94 },
{   2630 * OVERSAMPLENR,   91 },
{   2718 * OVERSAMPLENR,   88 },
{   2804 * OVERSAMPLENR,   85 },
{   2888 * OVERSAMPLENR,   82 },
{   2970 * OVERSAMPLENR,   79 },
{   3050 * OVERSAMPLENR,   76 },
{   3127 * OVERSAMPLENR,   73 },
{   3201 * OVERSAMPLENR,   70 },
{   3271 * OVERSAMPLENR,   67 },
{   3339 * OVERSAMPLENR,   64 },
{   3402 * OVERSAMPLENR,   61 },
{   3463 * OVERSAMPLENR,   58 },
{   3519 * OVERSAMPLENR,   55 },
{   3573 * OVERSAMPLENR,   52 },
{   3622 * OVERSAMPLENR,   49 },
{   3668 * OVERSAMPLENR,   46 },
{   3711 * OVERSAMPLENR,   43 },
{   3750 * OVERSAMPLENR,   40 },
{   3786 * OVERSAMPLENR,   37 },
{   3820 * OVERSAMPLENR,   34 },
{   3850 * OVERSAMPLENR,   31 },
{   3877 * OVERSAMPLENR,   28 },
{   3902 * OVERSAMPLENR,   25 },
{   3925 * OVERSAMPLENR,   22 },
{   3945 * OVERSAMPLENR,   19 },
{   3963 * OVERSAMPLENR,   16 },
{   3980 * OVERSAMPLENR,   13 },
{   3994 * OVERSAMPLENR,   10 }
};
#endif
