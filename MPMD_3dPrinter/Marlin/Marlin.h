...
void manage_inactivity(bool ignore_stepper_queue = false);
...
#else
  #define  enable_x() A4985_Reset();
  #define disable_x() {A4985_ReleaseReset(); axis_known_position[X_AXIS] = false;}
#endif
...
#else
  #define  enable_y() A4985_Reset();
  #define disable_y() {A4985_ReleaseReset(); axis_known_position[Y_AXIS] = false;}
#endif
...
#else
  #define  enable_z() A4985_Reset();
  #define disable_z() {A4985_ReleaseReset(); axis_known_position[Z_AXIS] = false;}
#endif
  ...
  #define disable_e4() BSP_MotorControl_ReleaseReset();
  ...
  #else
    #define  enable_e0() A4985_Reset();
    #define disable_e0() A4985_ReleaseReset();
  #endif
  ...
  #else
    #define  enable_e1() A4985_Reset();
    #define disable_e1() A4985_ReleaseReset();
  #endif
  ...
  #else
    #define  enable_e2() A4985_Reset();
    #define disable_e2() A4985_ReleaseReset();
  #endif
  ...
  #else
    #define  enable_e3() A4985_Reset();
    #define disable_e3() A4985_ReleaseReset();
  #endif
